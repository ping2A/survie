    ...
    for _ in 0..spawner_config.max_spawns_per_frame {
        ...
        let enemy = commands.spawn(
            ...
            .insert((
                ...
                SolidBodyCollider { offset: Vec2::new(0.0, 0.0), collider_type: ColliderType::Circle(40.0) },
                HitBoxCollider { collider_type: ColliderType::Circle(40.0) },
            ...
            .insert((
                ...
                SpriteFlip,
                IdleAnimation::new(
                    enemy_handles.enemy_configs[spawn_task.enemy_config_index].idle_animation.progress, 
                    enemy_handles.enemy_configs[spawn_task.enemy_config_index].idle_animation.sprite_row_length,
                    enemy_handles.enemy_configs[spawn_task.enemy_config_index].idle_animation.framecount,
                    enemy_handles.enemy_configs[spawn_task.enemy_config_index].idle_animation.atlas_row,
                    enemy_handles.enemy_configs[spawn_task.enemy_config_index].idle_animation.duration),
                MoveAnimationSide::new(
                    random::<f32>() * 10.0, 
                    enemy_handles.enemy_configs[spawn_task.enemy_config_index].move_animation_side.sprite_row_length,
                    enemy_handles.enemy_configs[spawn_task.enemy_config_index].move_animation_side.framecount,
                    enemy_handles.enemy_configs[spawn_task.enemy_config_index].move_animation_side.atlas_row,
                    enemy_handles.enemy_configs[spawn_task.enemy_config_index].move_animation_side.gameframes_until_loop),
