...
pub fn split_shot_system(
    ...
    for event in projectile_stopped_events.read() {
        ...
        for direction in directions {
            ...
            let projectile = command.spawn(SpriteSheetBundle {
                transform: projectile_transform,
                sprite: TextureAtlasSprite {
                    custom_size: Some(Vec2::new(64.0, 64.0)),
                    ..Default::default()
                },
                texture_atlas: texture_handle.basic_projectile_fireball.clone(),
                ..Default::default()
            })
