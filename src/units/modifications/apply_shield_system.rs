...
pub fn apply_shield_system(
    ...
    for apply_event in apply_events.read() {
        ...
        let child = commands.spawn(SpriteBundle {
            sprite: Sprite {
                custom_size: Some(Vec2::new(modification.unit_size.x, modification.unit_size.y)),
                ..Default::default()
            },
            ...
            .insert(HitBoxCollider { collider_type: ColliderType::Rectangle(Vec2::new(60.0, 60.0)) })
